...
class GraphPlotter:
    ...
    def plotScooterBatteryLevels(self, id):
    ...
    def plotBatteryBinsAtTime(self, desired_date, desired_time, cities, foldername='IDData'):
        ...
        desired_time = removeSeconds(desired_time)
        ...
        for filename in os.listdir(foldername):
            ...
            time_in_filename = filename.split('.')[0].split()[2]
            date_in_filename = filename.split('.')[0].split()[1]
    ...
    def avgConsumed(self, foldername):
...
if __name__ == '__main__':
    #trackNewScootersInCity('IDData')
    #plt.show()
    gp = GraphPlotter()
    #gp.avgConsumed('IDData')
    #gp.trackScooterAbsencesInPings(cities=['PBC'], foldername='IDData08-08')
    gp.trackNewScootersInCity('IDData')
    #plt.show()
    #avgConsumed('BirdIDData')
    #plt.show()
