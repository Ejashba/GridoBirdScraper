...
#reads PingLocations folder and converts each line to a Location instance
...
def resetScrapers():
    for scooter_name in scrapers:
        scrapers[scooter_name].resetScraper()
...
if __name__ == "__main__":
    ...
    #desired_cities = set(['MEX', 'PBC', 'OSL', 'ATL']) #add custom desired cities, comment out for all cities
    try:
        while True:
            #scraping operation
